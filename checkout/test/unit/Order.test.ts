...
test("Deve criar um pedido", function () {
    const order = new Order("160.455.710-96");
    const total = order.getTotal();
    expect(total).toBe(0);
});

test("Nao deve criar um pedido com Cpf Inválido", function () {
...
test("Deve criar um pedido com 3 itens com cupom de desconto", function () {
    const order = new Order("160.455.710-96", new Date("2021-03-01T10:00:00"));
    order.addItem(new Item(1, "Guitarra", 1000), 1);
    order.addItem(new Item(2, "Amplificador", 5000), 1);
    order.addItem(new Item(3, "Cabo", 30), 3);
...
test("Deve criar um pedido com 3 itens com cupom de desconto expirado", function () {
    const order = new Order("160.455.710-96", new Date("2022-03-10T10:00:00"));
    order.addItem(new Item(1, "Guitarra", 1000), 1);
    order.addItem(new Item(2, "Amplificador", 5000), 1);
    order.addItem(new Item(3, "Cabo", 30), 3);
    order.addCoupon(new Coupon("VALE20", 20, new Date("2022-03-01T10:00:00")));
...
test("Deve criar um pedido e gerar o código", function () {
    const order = new Order("160.455.710-96", new Date("2022-03-01T10:00:00"), 1);
    order.addItem(new Item(1, "Guitarra", 1000), 1);
    order.addItem(new Item(2, "Amplificador", 5000), 1);
    order.addItem(new Item(3, "Cabo", 30), 3);
